...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("--------------------------------------------");
        System.out.println("Paso 1, cargar valores de la ecuacion:");
        Raiz raiz1 = rs.cargarValoresRaiz();
        System.out.println("--------------------------------------------");
        System.out.println("Paso 2, Obtener discriminante:");
        System.out.println("Se aplica el metodo y se obtiene como resulatado: "+rs.getDiscriminante(raiz1));
        System.out.println("--------------------------------------------");
        System.out.println("Paso 3, tiene raices?:");
        System.out.println("Se aplica el metodo y el resultado arroja:"+ rs.tieneRaices(raiz1));
        System.out.println("Paso 4, tiene raiz?:");
        System.out.println("Se aplica el metodo y el resultado arroja:"+ rs.tieneRaiz(raiz1));
        System.out.println("--------------------------------------------");
        System.out.println("Paso 5, Obtener raices:");
        System.out.println("aplicando metodo...");
        rs.obtenerRaices(raiz1);
        System.out.println("--------------------------------------------");
        System.out.println("Paso 6, Obtener raiz:");
        System.out.println("aplicando metodo...");
